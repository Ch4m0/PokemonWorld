<template>
    <svg version="1.0" :width="width" :height="height" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" enable-background="new 0 0 64 64"
        xml:space="preserve" :fill="color">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            l-2.935-17.977l12.393-12.707C62.914,26.68,63.268,25.138,62.799,23.737z"></path>
        </g>
    </svg>
</template>
